...
print_test(server.update_stamping_by_user_id(query=UpdateStampingByUserId(user_id=test_user_id), body=StampingAccountModel(
    accountCode=account_nr, accountDistributionId=konto_acc_dist_id)))
EmploymentPublicScheduleModel(
    company_id=company_id,
    employee_id="640ca4b1-bf59-4740-9fc6-b1c6008861a0",  # matchar ID:t
    publicScheduleId=public_schedule_id,
    timeGroupId=time_group_id,
    fromDate=datetime(2027, 4, 20),
    toDate=datetime(2027, 4, 21)
)
...
print(server.create_employment_vehicle(EmploymentVehicleModel(
    company_id=company_id,
